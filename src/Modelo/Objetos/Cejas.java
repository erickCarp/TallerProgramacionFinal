...
public class Cejas implements ProcesaParte {
    private TipoParte cejas; ///este tipo de parte sabemos que es el modelo objeto boca
    ...
    public Cejas(TipoParte cejas) {
        this.cejas = cejas;
        try {
            image = ImageIO.read(new File(cejas.getUrl()));
        } catch (IOException e) {
            image = null;
        }
    }
